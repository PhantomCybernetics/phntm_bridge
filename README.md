...
Default Bridge configuration file was created in `~/phntm_bridge.yaml` in the previous step. \
Below is an example of such config, full list of configuration options can be found [here](https://docs.phntm.io/bridge/configuration).
```yaml
## Generated by https://bridge.phntm.io
## On 2024-11-17T00:20:49.309Z
## For IP ::ffff:24.108.93.166
##
## Robot UI is available at:
## https://bridge.phntm.io/673936e1ebca4772ab1bd657

/**:
  ros__parameters:
    id_robot: 673936e1ebca4772ab1bd657
    key: 673936e1ebca4772ab1bd656
    name: 'Unnamed Robot'
...
### Configure the Agent
Here's an example config file for the Phntm Agent (~/phntm_agent.yaml)
```yaml
/**:
  ros__parameters:
